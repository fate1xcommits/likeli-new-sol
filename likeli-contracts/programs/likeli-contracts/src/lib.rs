...
pub mod likeli_contracts {
    ...
    pub fn buy_multi(
        ...
        // NegRisk: Prices may temporarily not sum to 100%.
        // Arbitrageurs use convert_positions() to profit from mispricing,
        // which naturally pushes prices back toward equilibrium.
        // This is the Polymarket approach - no auto-rebalancing needed.
    ...
    // rebalance_market instruction removed - using Polymarket-style arbitrage via convert_positions()
...
// sync_sibling_pools function removed - using Polymarket-style arbitrage via convert_positions()
// Prices may temporarily not sum to 100%, but arbitrageurs profit by correcting mispricing.
